...
class BookServiceTest {
  ...
  void shouldCreateBookWhenIsbnDoesNotExist() {
    ...
    metadata.setCoverUrl("https://covers.openlibrary.org/b/isbn/9780134685991-L.jpg");
    ...
    assertThat(capturedBook.getThumbnailUrl())
        .isEqualTo("https://covers.openlibrary.org/b/isbn/9780134685991-L.jpg");
  }
}
